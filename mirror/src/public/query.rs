...
//! Utility entity for managing queries submitted over our rocket endpoint and
//! resolved by the GRPC polling mechanism.

use mc_full_service_mirror::wallet_service_mirror_api::{QueryRequest, QueryResponse};
use rand::RngCore;
use std::{
    collections::HashMap,
...
/// The length of the randomly generated query id that is used to tie requests
...
struct QueryManagerInner {
    /// Map of query id -> query of queries that need to get sent to the private
    /// side of the mirror.
