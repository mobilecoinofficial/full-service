...
// tx_proposal::TxProposal}; use serde::{Deserialize, Serialize};
...
// impl TryFrom<&JsonRPCRequest> for ApiRequest {
//     type Error = String;

//     fn try_from(src: &JsonRPCRequest) -> Result<ApiRequest, String> {
...
//         *method = method_alias(method.as_str().ok_or("Method is not a
// string")?).into();

//         serde_json::from_value(src_json).map_err(|e| format!("Could not get
// value {:?}", e))     }
// }
...
// "get_transaction_logs_for_account",         "get_all_txos_for_account" =>
// "get_txos_for_account",         _ => m,
//     }
// }
