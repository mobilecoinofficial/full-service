...
mod e2e {
    ...
    //     let main_account_address =
    // b58_decode_public_address(main_address).unwrap();
    ...
    //     // remove regular account (can't have both view only and regular in
    // same wallet)     let body = json!({
    //         "jsonrpc": "2.0",
    //         "id": 2,
    //         "method": "remove_account",
    //         "params": {
