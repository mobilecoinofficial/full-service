...
impl JsonTransactionLog {
    pub fn new(transaction_log: &TransactionLog, associated_txos: &AssociatedTxos) -> Self {
        ...
        Self {
            ...
            submitted_block_height: transaction_log.submitted_block_index.map(|b| b.to_string()),
            finalized_block_height: transaction_log.finalized_block_index.map(|b| b.to_string()),
